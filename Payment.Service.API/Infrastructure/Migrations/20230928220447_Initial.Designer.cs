...
namespace Plooto.Assessment.Payment.API.Infrastructure.Migrations
{
    ...
    [Migration("20230928220447_Initial")]
            ...
            modelBuilder.Entity("Plooto.Assessment.Payment.Domain.Bill", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 9, 28, 22, 4, 47, 405, DateTimeKind.Unspecified).AddTicks(978), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Plooto.Assessment.Payment.Domain.PaymentDetail", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 9, 28, 22, 4, 47, 395, DateTimeKind.Unspecified).AddTicks(9057), new TimeSpan(0, 0, 0, 0, 0)));
